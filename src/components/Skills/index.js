          ...
          <div className="skills__cards__card--ctn">
            ...
            <div className="skills__cards__card__list skills__cards__card__list--large">
              <div
                ...
                aria-label="Intégration HTML propre et sémantique"
              ...
              <div
                className="skills__cards__card__list__item"
                aria-label="Mise en forme grâce au CSS"
                data-cooltipz-dir="top"
              >
                <img
                  src={css}
              ...
              <div
                className="skills__cards__card__list__item"
                aria-label="Programmation Orientée Objet"
                data-cooltipz-dir="top"
              >
                <img
                  src={php}
        ...
        <div className="skills__cards__card skills__cards__card--spec">
          <div className="skills__cards__card--ctn">
            ...
            <div className="skills__cards__card__list">
              <div
                className="skills__cards__card__list__item"
                aria-label="Développement React"
                data-cooltipz-dir="top"
              >
                <img
                  src={react}
        ...
        <div className="skills__cards__card skills__cards__card--divers">
          <div className="skills__cards__card--ctn">
            ...
            <div className="skills__cards__card__list">
              ...
              <div
                className="skills__cards__card__list__item"
                aria-label="Utilisation de Linux"
                data-cooltipz-dir="top"
              >
                <img
                  src={linux}
              ...
              <div
                className="skills__cards__card__list__item"
                aria-label="Utilisation de Windows"
                data-cooltipz-dir="top"
              >
                <img
                  src={win}
              ...
              <div
                className="skills__cards__card__list__item"
                aria-label="Création de maquettes"
                data-cooltipz-dir="top"
              >
                <img
                  src={figma}
