...
import { ReactComponent as Svg } from "Assets/images/animated-logo.svg";
// styles
...
function AnimatedLogo() {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        ...
                        o && (s = -s),
                        (a =
                          E(a, F(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * R),
                        o && (a = -a),
                        {
                          origin: { x: d(e[4]), y: d(e[5]) },
                          translate: { x: d(t), y: d(n) },
          ...
          animations: [
            {
              elements: {
                e2751gCS3Nc2: {
                  transform: {
                    data: {
                      o: { x: 185.672455, y: 183.436218, type: "corner" },
                      t: { x: -185.672455, y: -183.436218 },
                    },
                    keys: {
                      r: [
                        { t: 800, v: 180 },
                ...
                e2751gCS3Nc13: {
                  transform: {
                    data: {
                      o: { x: 187.501953, y: 186.552734, type: "corner" },
                      t: { x: -187.501953, y: -186.552734 },
                    },
                    keys: {
                      s: [
                        { t: 1200, v: { x: 0, y: 0 } },
                ...
                e2751gCS3Nc71: {
                  transform: {
                    data: {
                      o: { x: 187.735703, y: 187.512467, type: "corner" },
                      t: { x: -187.735702, y: -187.512467 },
                    },
                    keys: {
                      s: [
                        { t: 0, v: { x: 2, y: 2 } },
              ...
              s: "MTDA1M2M1NmNhZWJmYmBNhYmJlYjNiOWI4NmMN4NDdjN2E3YTdhNzY2RY2FlYjNiY2FmYWRiZJWIzYjliODZjVVU4NDTdiNzY2Y2IzYmVhZmJVjYWJiZWIzRWI5YjhiKZDZjODQ3Yjc2NmNZYUjBiM2I2YjY2Yzg0N2VI3NjZjYWJiNmJlYWZAiY2I4YWJiZWFmNmM4ONGIwYWJiNmJkYWY3NDjZjYmRiYWFmYWZhZTFZjODQ3YmM3",
            },
          ],
          options: "MHDAxMDg4MmY4MDgxNmDU3ZjgxMmY0NzJmNzkM3YzZlRTcxMmZGOGE/V",
        },
        "__SVGATOR_PLAYER__",
        window
      );
  ...
  return (
    <div className="logo__animated">
      <Svg className="logo__animated__svg" />
    </div>
  );
}
